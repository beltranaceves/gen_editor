...
export const ElementToggleBox = {
    ...
    <section id="moduledoc">
        ...
        <pre><code class="makeup shell" translate="no"><span class="gp unselectable">$ </span><span class="">mix phx.gen.auth Accounts User users</span></code></pre>
    ...
    <section id="moduledoc">
        ...
        <pre><code class="makeup shell" translate="no"><span class="gp unselectable">$ </span><span class="">mix phx.gen.notifier Accounts User welcome_user --context-app marketing</span>
        </code>
        </pre>
